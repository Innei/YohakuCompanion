        ...
        OnboardingStepLayout(
            ...
            VStack(alignment: .leading, spacing: 14) {
                OnboardingExplanationRow(
                    ...
                    detail: "Share a short-lived snapshot of the foreground application and eligible media with Yohaku Live Desk."
                )
                OnboardingExplanationRow(
        ...
        OnboardingStepLayout(
            ...
            SettingsGroup("Sources") {
                ...
                SettingsToggleRow(
                    ...
                    detail: "Share sanitized media identity and playback timing when Yohaku advertises media timeline support.",
                    isOn: Binding(
